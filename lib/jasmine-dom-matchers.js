...
jasmine.DOM.indexOf = function () {
  if ([].indexOf) {
    return function (arrayLike, obj, startIndex) {
      return [].indexOf.call(arrayLike, obj, startIndex);
    };
  } else {
    return function (arrayLike, obj, startIndex) {
      var i = startIndex || 0;
...
(function(){
  var matchers = {
    ...
    toHaveClass: function(className)
    {
      ...
      return -1!==jasmine.DOM.indexOf(classes, className);
    },
    ...
    toMatchSelector: function(selector)
    {
      ...
      return -1!==jasmine.DOM.indexOf(nodes, this.actual);
    },
